			...
			, function(){
				...
				if (this.settings[extensionName]) {
					...
					if (typeof oursettings !== 'function') {
						...
						var undoButtonSytle = 'position:absolute;display:none;margin:65px !important;top:auto;right: 100px !important; '
						, $undoButton = $('<input type="button" class="btn btn-danger" value="Reset Signature" style="'+undoButtonSytle+'" />')
